    ...
    <div>
      <nav className="flex justify-between h-16 bg-gradient-to-r from-[#10357a] via-[#032759] to-cyan-950 items-center ">
        ...
        <div className=" w-[29rem] mr-10">
          <ul className="flex  w-full justify-between">
            <li>
              <Link to="/" className="text-lg font-medium text-white" onClick={drop?HandleDropDownMenu:Nothing}>
                Home
              </Link >
            </li>
            <li>
              <Link to="/contact" className="text-lg font-medium text-white" onClick={drop?HandleDropDownMenu:Nothing}>
                Contact
              </Link>
            </li>
            <li>
              <Link to="/dashboard" className="text-lg font-medium text-white" onClick={drop?HandleDropDownMenu:Nothing}>
                Dashboard
              </Link>
            </li>
            <li>
      ...
      <div
        className={`transition-opacity  duration-300  ease-linear ${
          drop ? "opacity-100 visible" : "opacity-0 invisible"
        }`}
      >
        <DropDown HandleDrop={HandleDropDownMenu}/>
      </div>
    </div>
    <Outlet/>
    </>
